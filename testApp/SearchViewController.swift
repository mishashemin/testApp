...
class SearchViewController: UIViewController{
    ...
    func cellCraft( _ cell : MainTableViewCell,_ indexPath: IndexPath)->MainTableViewCell{
        ...
        case .user:
            ...
            cell.craftParm(type: .user, name: name, id: items[index].id!, imgLink: link, screenName: items[index].screenName!)
        ...
        case .group:
            ...
            cell.craftParm(type: .group, name: items[index].name!, id: items[index].id!, imgLink: link, screenName: items[index].screenName!)
